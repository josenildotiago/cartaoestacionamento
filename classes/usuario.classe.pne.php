...
class Usuario{
    ...
    public function getInfoLogado($id){
        $sql = "SELECT * FROM usu_cadastro_pne WHERE id = :id";
    ...
    public function getInfoLogadoPendente($id){
        $sql = "SELECT * FROM usu_cadastro_pne_pendencias WHERE id = :id";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':id', $id);
        $sql->execute();
    ...
    public function adicionar($nome, $sexo, $cpf, $nascimento, $cep, $rua, $numero, $cidade, $bairro, $uf, $ibge, $usuario, $antigo, $obs) {
        ...
        if(count($emailexistente) == 0){
            $sql = "INSERT INTO usu_cadastro_pne SET nome = :nome, sexo = :sexo, cpf = :cpf, nacimento = :nacimento, cep = :cep, rua = :rua, numero = :numero, cidade = :cidade, bairro = :bairro, uf = :uf, ibge = :ibge, usuario = :usuario, id_antigo = :id_antigo, obs = :obs";
            $sql = $this->pdo->prepare($sql);
    ...
    public function deletarPendencia($id){
        $sql = "DELETE FROM usu_cadastro_pne_pendencias WHERE id = :id";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':id', $id);
        if ($sql->execute()) {
    ...
    public function moverPendencia($id) {
        $sql = "INSERT INTO usu_cadastro_pne (nome, sexo, cpf, nacimento, cep, rua, numero, cidade, bairro, uf, ibge, usuario, id_antigo, obs) SELECT nome, sexo, cpf, nacimento, cep, rua, numero, cidade, bairro, uf, ibge, usuario, id_antigo, obs FROM usu_cadastro_pne_pendencias WHERE id = :id";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':id', $id);
        if ($sql->execute()) {
            $sql = "DELETE FROM usu_cadastro_pne_pendencias WHERE id = :id";
    ...
    public function editarPendencia($nome, $sexo, $cpf, $nascimento, $cep, $rua, $numero, $cidade, $bairro, $uf, $ibge, $usuario, $antigo, $obs, $id) {
        $sql = "UPDATE usu_cadastro_pne_pendencias SET nome = :nome, sexo = :sexo, cpf = :cpf, nacimento = :nacimento, cep = :cep, rua = :rua, numero = :numero, cidade = :cidade, bairro = :bairro, uf = :uf, ibge = :ibge, usuario = :usuario, id_antigo = :id_antigo, obs = :obs WHERE id = :id";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':id', $id);
        $sql->bindValue(':nome', $nome);
        $sql->bindValue(':sexo', $sexo);
    ...
    public function editar($nome, $sexo, $cpf, $nascimento, $cep, $rua, $numero, $cidade, $bairro, $uf, $ibge, $usuario, $antigo, $obs, $id) {
            $sql = "UPDATE usu_cadastro_pne SET nome = :nome, sexo = :sexo, cpf = :cpf, nacimento = :nacimento, cep = :cep, rua = :rua, numero = :numero, cidade = :cidade, bairro = :bairro, uf = :uf, ibge = :ibge, usuario = :usuario, id_antigo = :id_antigo, obs = :obs WHERE id = :id";
            $sql = $this->pdo->prepare($sql);
            $sql->bindValue(':id', $id);
            $sql->bindValue(':nome', $nome);
            $sql->bindValue(':sexo', $sexo);
    ...
    private function existeCpf($cpf) {
        $sql = "SELECT id FROM usu_cadastro_pne WHERE cpf = :cpf";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':cpf', $cpf);
        $sql->execute();
    ...
    private function existeCpf2($cpf) {
        $sql = "SELECT cpf FROM usu_cadastro_pne WHERE cpf = :cpf";
        $sql = $this->pdo->prepare($sql);
        $sql->bindValue(':cpf', $cpf);
        $sql->execute();
