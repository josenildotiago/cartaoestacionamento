...
$_SESSION['editar'] = $id;
$u = new Usuario();
$usuario = $u->getInfoLogadoPendente($id);
...
<div class="container theme-showcase" role="main" >
    ...
    <form action="update.pne.pendencias.php" method="post">
        <div class="form-row">
            <?php 
            ...
            <p class="col-12"></p>
            <div class="">
                <input id="zer" type="submit" value="Mover para Aprovados" class="btn btn-primary" >
