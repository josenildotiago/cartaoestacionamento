...
$result_usuario = "SELECT * FROM usu_cadastro_pne ORDER BY id $ordem LIMIT $inicio, $qnt_result_pg";
			...
			<tbody>
				...
				while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
					...
					?>
						...
						<td><?php echo "<a class='btn btn-primary btn-sm' href='editar.pne.php?id=$id' ><i class='fas fa-user-edit' ></i></a>
									<a class='btn btn-success btn-sm' href='visualizar.pne.php?id=$id' ><i class='far fa-eye'></i></a>"; ?></td>
					</tr>
