...
$result_usuario = "SELECT * FROM usu_cadastro ORDER BY id $ordem LIMIT $inicio, $qnt_result_pg";
...
if(($resultado_usuario) AND ($resultado_usuario->num_rows != 0)){
			...
			<tbody>
				...
				while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
					...
					?>
						...
						<td><?php echo "<a class='btn btn-primary btn-sm' href='editar.php?id=$id' ><i class='fas fa-user-edit' ></i></a>
									<a class='btn btn-success btn-sm' href='visualizar.php?id=$id' ><i class='far fa-eye'></i></a>"; ?></td>
					</tr>
	...
	$result_pg = "SELECT COUNT(id) AS num_result FROM usu_cadastro";
