...
if ($a == "buscar") {
	...
	$querySelect = $conn->query("SELECT * FROM usu_cadastro_pne WHERE nome LIKE '%".$palavra."%' ORDER BY nome");
while ($registros = $querySelect->fetch_assoc()):
    ...
    echo "  <td>$id</td>
            ...
            <td>$bairro</td>
            <td>$uf</td>
            <td><a class='btn btn-primary btn-sm' href='editar.pne.php?id=$id' role='button'>Editar</a>
            <a class='btn btn-success btn-sm' href='visualizar.pne.php?id=$id' role='button'>Visualizar</a>";
    echo "</tr>";
endwhile;
	...
	if ($affected_rows == 0) {
        ...
        <?php
		//header("Location: consulta_nome.pne.php");
	}
