...
<?php include ('../includes/header.menu.pne.php'); ?>
...
<?php if(isset($_SESSION['msg'])){ echo $_SESSION['msg']; unset($_SESSION['msg']); } ?>
    ...
    <form action="create.pne.php" method="POST">
        <div class="form-row">
            <!-- CAMPO NOME -->
            ...
            <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" name="cidade" id="cidade" placeholder="Cidade" style="text-transform: uppercase" >
            </div>
            <!-- CAMPO ESTADO -->
            <div class="form-group col-md-1">
...
var pagina = 1;
    ...
    $.post('listar_usuarios_jquery.pne.php', dados, function(retorna){
        $("#conteudo").html(retorna);
    });
    }
</script>
<?php include ('../includes/footer.pne.php'); ?>